...
public static class Utility
{
    ...
    public static void MouseScrollDown()
    {
        ...
        inputs[0] = new Input
        {
            ...
            Union = new InputUnion
            {
                mouse = new MouseInput
                {
                    mouseData = -120, // Negative for scroll down
    ...
    public static void HardwareSpaceDown()
    {
        var inputs = new Input[1];
        inputs[0] = new Input
        {
    ...
    public static void HardwareSpaceUp()
    {
        var inputs = new Input[1];
        inputs[0] = new Input
        {
    ...
    public static bool Write<T>(this System.Diagnostics.Process process, IntPtr lpBaseAddress, T value)
        where T : unmanaged
    {
        return Write(process.Handle, lpBaseAddress, value);
    }

    public static bool Write<T>(this Module module, int offset, T value)
        where T : unmanaged
    {
        return Write(module.Process.Handle, module.ProcessModule.BaseAddress + offset, value);
    }

    private static bool Write<T>(IntPtr hProcess, IntPtr lpBaseAddress, T value)
        where T : unmanaged
    {
        var size = Marshal.SizeOf<T>();
        var buffer = new byte[size];
        ...
        try
        {
            ...
            return Kernel32.WriteProcessMemory(hProcess, lpBaseAddress, buffer, size, out _);
        }
        finally
        {
